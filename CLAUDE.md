...
**Core pattern**: Supervisor runs Channel Actor (Telegram I/O), Session Actor (Claude + tools + memory), and Reminder Actor (cron tasks). Each actor panics safely and restarts with exponential backoff.
